        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                    <p>シナリオ数</p>
                    <h3><?php echo 0; ?><span style="font-size: 2rem;" >件</span></h3>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
                <a href="<?php echo admin_url(); ?>scenario" class="small-box-footer">もっと見る <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                    <p>企業</p>
                    <h3><?php echo $company_count;?><span style="font-size: 2rem;" >人</span></h3>
                </div>
                <div class="icon">
                  <i class="ion ion-person-add"></i>
                </div>
                <a href="<?php echo admin_url(); ?>user" class="small-box-footer">もっと見る<i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <?php
            }
