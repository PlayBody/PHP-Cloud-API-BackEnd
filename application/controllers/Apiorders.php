...
class Apiorders extends WebController
{
    ...
    public function loadOrderList(){
        ...
        if($is_reserve_list)
            $cond['status_array'] = [ORDER_STATUS_RESERVE_REQUEST, ORDER_STATUS_RESERVE_REJECT, ORDER_STATUS_RESERVE_CANCEL, ORDER_STATUS_RESERVE_APPLY, ORDER_STATUS_TABLE_COMPLETE];
